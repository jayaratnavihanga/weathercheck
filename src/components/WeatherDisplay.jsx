...
const WeatherDisplay = ({weather = {}}) => {
    ...
    return (
        <div className="flex flex-rowl py-8">
            <div className="basis-1/2 pt-3  pr-4 pl-6">
                <div
                    className="bg-white bg-clip-padding backdrop-filter  backdrop-blur bg-opacity-10 backdrop-saturate-100 backdrop-contrast-10000 p-6 rounded-lg shadow-lg max-w-sm mx-auto">
            ...
            <div className="basis-1/2  p-2"><WeatherInfoCards weather={weather}/>
            </div>
